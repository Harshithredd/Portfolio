...
export const ArrowBoxDownIcon = ({ className, ...rest }) => (
  <svg
    width="50px"
    height="50px"
    viewBox="0 0 24 24"
    className={`w-full h-auto ${className} md:h-11 md:w-11`}
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
    {...rest}
  >
    <path
      ...
      className={` dark:!fill-light/90 fill-dark/90 `}
    />
  </svg>
);

export const ArrowBoxUpIcon = ({ className, ...rest }) => (
  <svg
    width="50px"
    height="50px"
    viewBox="0 0 24 24"
